...
const { schemaCadastroUsuario } = require('../funcoes_verificacao/verificar_requisicao_body');
...
const cadastrarUsuario = async (req, res) => {
    ...
    try {
        ...
        if (emailExistente) {
            return res.status(400).json({ "mensagem": "Este email ja foi cadastrado. Favor escolha outro email." })
        };
